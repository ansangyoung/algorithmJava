...
public class string72410 {
	public static void main(String[] args) {
		...
		soultion.solution(new_id);	// bat.y.abcdefghi
		
		new_id = "z-+.^.";
		soultion.solution(new_id);	// z--
		
		new_id = "=.=";
		soultion.solution(new_id);	// aaa
		
		new_id = "123_.def";
		soultion.solution(new_id);	// 123_.def
		
		new_id = "abcdefghijklmn.p";
		soultion.solution(new_id);	// abcdefghijklmn
	}
}
